...
public class BBQDFoods {
    ...
    public static final FoodComponent GRILLED_LAMB_SKEWER = new FoodComponent.Builder().hunger(12).saturationModifier(0.6f).statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 20 * 60, 0), 0.5f).build();
    ...
    public static final FoodComponent GRILLED_BEEF_SKEWER = new FoodComponent.Builder().hunger(10).saturationModifier(0.6f).statusEffect(new StatusEffectInstance(StatusEffects.STRENGTH, 20 * 60, 0), 0.5f).build();
    ...
    public static final FoodComponent GRILLED_FRUIT_AND_VEGETABLE_SKEWER = new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 20 * 120, 0), 0.5f).build();
